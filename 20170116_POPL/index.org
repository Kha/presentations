...
- Assign computational interpretations to programs outside the logic (i.e =io=)
...
- Denote IR into C++
    - easier to prototype and configure than LLVM
...
* Future Work
  - Framework for rewriting based on equality (in the theory)
    - We can use existing simplifier to do optimizations
  - Formally verify compiler
